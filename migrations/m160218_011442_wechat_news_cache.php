...
class m160218_011442_wechat_news_cache extends \yii\db\Migration {
	...
	public function up() {
		...
		$this->createTable('{{%wechat_news_cache}}', [
			...
			'pid' => Schema::TYPE_INTEGER . ' not null default 0 comment "父id"',
			'newsid' => Schema::TYPE_INTEGER . ' comment "图文素材id"',
			'title' => Schema::TYPE_STRING . '(50) comment "标题"',
			'author' => Schema::TYPE_STRING . '(50) comment "作者"',
			'thumb_materialid' => Schema::TYPE_INTEGER . ' comment "封面图片素材id(必须是永久素材媒体)"',
			...
			'content' => Schema::TYPE_TEXT . ' comment "内容, <=2万字符, <=1MB, 具备微信支付权限可以使用a标签"',
