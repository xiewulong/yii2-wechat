...
class m160115_081300_wechat extends \yii\db\Migration {
	...
	public function up() {
		...
		$this->createTable('{{%wechat}}', [
			...
			'count_image' => Schema::TYPE_INTEGER . ' not null default 0 comment "图片总数量"',
			'count_voice' => Schema::TYPE_INTEGER . ' not null default 0 comment "语音总数量"',
			'count_video' => Schema::TYPE_INTEGER . ' not null default 0 comment "视频总数量"',
			'count_news' => Schema::TYPE_INTEGER . ' not null default 0 comment "图文总数量"',
