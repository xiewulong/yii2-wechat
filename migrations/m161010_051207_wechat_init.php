...
class m161010_051207_wechat_init extends Migration {
	...
	public function safeUp() {
		...
		$this->createTable('{{%wechat}}', [
			...
			'access_token_expired_at' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'access token expired time')),
			'jsapi_ticket' => $this->text()->comment(\Yii::t($this->messageCategory, 'js api ticket')),
			'jsapi_ticket_expired_at' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'js api ticket expired time')),
			'ip_list' => $this->text()->comment(\Yii::t($this->messageCategory, 'wechat server ip list')),
			'count_image' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'image quantity')),
			'count_voice' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'voice quantity')),
			'count_video' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'video quantity')),
			'count_news' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'news quantity')),
		...
		$this->createTable('{{%wechat_user}}', [
			...
			'subscribe' => $this->boolean()->notNull()->comment(\Yii::t($this->messageCategory, 'subscribe status')),
			...
			'groupid' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'user group id')),
			'sex' => $this->boolean()->notNull()->comment(\Yii::t($this->messageCategory, 'sex')),
			...
			'privilege' => $this->text()->comment(\Yii::t($this->messageCategory, 'privilege')),
			'access_token' => $this->text()->comment(\Yii::t($this->messageCategory, 'user page authorization interface access token')),
			'access_token_expired_at' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'user page authorization interface access token expired time')),
		...
		$this->createTable('{{%wechat_user_group}}', [
			...
			'count' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'user quantity')),
			'created_at' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'created time')),
			'updated_at' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'updated time')),
		], $tableOptions);
		...
		$this->createTable('{{%wechat_news_item}}', [
			...
			'show_cover_pic' => $this->boolean()->notNull()->comment(\Yii::t($this->messageCategory, 'show cover picture')),
		...
		$this->createTable('{{%wechat_menu}}', [
			'id' => $this->primaryKey()->comment(\Yii::t($this->messageCategory, 'id')),
			'appid' => $this->string(68)->notNull()->comment(\Yii::t($this->messageCategory, 'app id')),
			'conditional' => $this->boolean()->notNull()->comment(\Yii::t($this->messageCategory, 'personalized menu')),
			'pid' => $this->integer()->notNull()->comment(\Yii::t($this->messageCategory, 'parent id')),
			...
			'sex' => $this->boolean()->comment(\Yii::t($this->messageCategory, 'sex')),
			'client_platform_type' => $this->boolean()->comment(\Yii::t($this->messageCategory, 'client platform type')),
			'country' => $this->string(68)->comment(\Yii::t($this->messageCategory, 'country')),
			'province' => $this->string(68)->comment(\Yii::t($this->messageCategory, 'province')),
			'city' => $this->string(68)->comment(\Yii::t($this->messageCategory, 'city')),
			'language' => $this->string(68)->comment(\Yii::t($this->messageCategory, 'language')),
		...
		$this->createTable('{{%wechat_message_keyword}}', [
			...
			'mode' => $this->boolean()->notNull()->comment(\Yii::t($this->messageCategory, 'matching pattern')),
